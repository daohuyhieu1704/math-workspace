...
enum OdMessage
{
	...
	OD_MESSAGE_DEF(sidDictionary, OD_T("%ls Dictionary")) // param: Dictionary m_name
	OD_MESSAGE_DEF(sidTable, OD_T("%ls Table")) // param: Table m_name
	...
	OD_MESSAGE_DEF(sidDbLtMissed, OD_T("LineType %ls missing")) // param: line type m_name
	...
	OD_MESSAGE_DEF(sidDbLtByBlockName, OD_T("LineType ByBlock has invalid m_name \"%ls\""))
	OD_MESSAGE_DEF(sidDbLtByBlockInList, OD_T("LineType ByBlock placed in ordinary list"))
	OD_MESSAGE_DEF(sidDbLtByLayerName, OD_T("LineType ByLayer has invalid m_name %ls"))
	...
	OD_MESSAGE_DEF(sidDbDictionaryMissed, OD_T("%ls dictionary missing"))   // param: dictionary m_name (ACAD_MLSTYLE, ACAD_GROUP, ...)
	...
	OD_MESSAGE_DEF(sidObjPropLinetypeName, OD_T("LineType m_name \"%ls\""))
	...
	OD_MESSAGE_DEF(sidMLineStyleName, OD_T("MLineStyle m_name \"%ls\""))
	...
	OD_MESSAGE_DEF(sidRecSpaceNameInvalid, OD_T("\"%ls\" record m_name \"%ls\""))
	OD_MESSAGE_DEF(sidRecNameEmpty, OD_T("Record m_name is empty"))
	OD_MESSAGE_DEF(sidRecNameInvalidChars, OD_T("Character(s) in record m_name"))
	OD_MESSAGE_DEF(sidRecCommentInvalidChars, OD_T("Character(s) in record comment"))
	OD_MESSAGE_DEF(sidRecDuplicateName, OD_T("Duplicate record m_name \"%ls\""))
	...
	OD_MESSAGE_DEF(sidRecXRefInvalidFlag, OD_T("Is not externally dependent on an Xref, but XRefBlockId (%ls) is valid and m_name has vertical bar"))
	OD_MESSAGE_DEF(sidRecXRefDepNameInvalid, OD_T("Is externally dependent on an Xref, but m_name (%ls) has no vertical bar"))
	...
	// Shapes
	OD_MESSAGE_DEF(sidUnknownShapeName, OD_T("Can't resolve Shape m_name \"%ls\""))
	...
	OD_MESSAGE_DEF(sidCantGetShapeName, OD_T("Can't get Shape m_name without \"%ls\""))
	...
	OD_MESSAGE_DEF(sidRecvRootObjInvalid, OD_T("Root object %ls")) // class m_name
	OD_MESSAGE_DEF(sidRecvBadRootTables, OD_T("Unable to recover root tables"))
	OD_MESSAGE_DEF(sidRecvBadDictionary, OD_T("%ls (%ls)"))  // 1 - dic class, 2 - dic m_name
	...
	OD_MESSAGE_DEF(sidCurrentDimstyle, OD_T("Database current: %ls")) // param: Dimstyle m_name
